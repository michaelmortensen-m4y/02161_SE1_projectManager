...
public class TestRegisterNewEmployee {
	 ...
	 */
	@Test
	public void testRegisterEmployee() { // Black-box test A and white-box test A
	 ...
	 */
	@Test
	public void testRegisterWithInvalidInitials() { // Black-box test B and White-box test B,C,E
		...
		// Try to register with different initials
		try {
		...
		// Check that no employees have been added to the system
		assertEquals(0, employees.size());
	}
	 ...
	 */
	@Test
	public void testRegisterMultipleEmployees() { // Black-box test C and white-box test F
	...
	/** 
	 * Tests registering a the same employee twice.
	 * <ol>
	 *  <li> The user registers a new employee
	 *  <li> The user logs out
	 * 	<li> The user tries to register another employee with the same initials
	 *  <li> The project application knows that the user can not register an employee already existing in the system
	 * </ol>
	 */
	@Test
	public void testRegisterSameEmployeeTwice() { // White-box test D
		...
		// Try to register another employee with same initials
		try {
			projectApp.registerNewEmployee("abcd");
			fail("An exception should have been thrown");
		} catch (InitialsInvalidException e) {
		...
		// Check that still only one employee is registered and that it is "abcd"
		assertEquals(1, employees.size());
		assertEquals("abcd", employees.get(0).getInitials());
	}
